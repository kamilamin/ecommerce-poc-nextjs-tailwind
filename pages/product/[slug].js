                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <div className='flex mx-2'>
                                <button onClick={() => addToCart(slug, 1, product.attributes.price)} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 mx-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
                                <button onClick={() => router.push('/checkout')} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 mx-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Checkout</button>
                            </div>
